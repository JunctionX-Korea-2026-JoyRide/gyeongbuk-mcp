...
| 상가(상권)정보 ZIP | [공공데이터포털](https://www.data.go.kr/data/15083033/fileData.do) | 2026-06-30 | 경북 CSV의 상가업소번호, 3단계 업종, 주소, 위도, 경도 |
...
상가(상권)정보는 약 353MB 전국 ZIP을 임시 파일로 스트리밍 다운로드한 뒤 SHA-256과 ZIP CRC를
검증합니다. 빌더는 내부 경북 CSV 하나만 읽어 유효 좌표를 가진 영업 중 업소를 적재합니다.
